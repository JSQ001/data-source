...
-- 初始化组件
INSERT INTO component VALUES (REPLACE(UUID(),'-',''),'focus-news','训管要闻',null,0,0,null,null,3, 10,1,null,1,1,1,0,now(),now(),'init','init',0);
...
INSERT INTO component VALUES (REPLACE(UUID(),'-',''),'notice-announcement','通知公告',null,0,0,null,null,3, 10,1,null,1,1,1,0,now(),now(),'init','init',0);
...
INSERT INTO component VALUES (REPLACE(UUID(),'-',''),'training-management-information','通知公告',null,0,0,null,null,3, 10,1,null,1,1,1,0,now(),now(),'init','init',0);
INSERT INTO component_personal_config VALUES(REPLACE(UUID(),'-',''),(SELECT id from (SELECT id from component WHERE code = 'training-management-information') t1),0,null,0,10,3,10);
